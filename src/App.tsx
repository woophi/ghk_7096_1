...
const LINK =
  'a-investments://CA?type=sdui_screen&screenName=InvestmentLongread&fromCurrent=true&shouldUseBottomSafeArea=true&endpoint=v1/invest-main-screen-view/investment-longread/94346%3flocation=AM%26campaignCode=GH';
...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', '7096_start_course', { var: 'var1' });
      ...
      <div className={appSt.container}>
        ...
        {faqs.map((faq, index) => (
          <div key={index}>
            <div
              onClick={() => {
                window.gtag('event', '7096_children_faq', { faq: String(index + 1), var: 'var1' });
